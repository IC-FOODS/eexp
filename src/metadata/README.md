 ...
 * [eexp.yml](eexp.yml)
     * Determines how your purl.obolibrary.org/obo/eexp/ redirects will be handled
     ...
     * Paste in the contents of [eexp.yml](eexp.yml)
 ...
 * [eexp.md](eexp.md)
     ...
     * Paste in the contents of [eexp.md](eexp.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
